-- Include user rankings in community averages for all buckets.
-- (20260219150000 may have been skipped during push; this ensures the fix is applied.)
-- Community = AVG(baseline + all user rankings) per player.
