...
const WEIGHTS: Record<string, Partial<Record<'RB' | 'WR' | 'QB' | 'TE' | 'DST' | 'K', PhaseWeights>>> = {
  ...
  hero_rb: { RB: [1.55, 0.75, 0.9], WR: [1.0, 1.2, 1.0], QB: [0.8, 1.0, 1.0], TE: [0.9, 0.9, 1.0], DST: [0, 0, 1.0], K: [0, 0, 0.8] },
  robust_rb: { RB: [1.35, 1.1, 0.9], WR: [0.75, 1.0, 1.1], QB: [0.5, 1.0, 1.1], TE: [0.6, 0.9, 1.0], DST: [0, 0, 1.0], K: [0, 0, 0.8] },
